  ...
  constructor(game, options = {}) {
    ...
    this.holeConfigs = [
      ...
      // 🕳️ 3. Zig-Zag Alley
      {
        ...
        hazards: [],
        bumpers: [
          // Bumpers assumed local relative to 0,0,0
          {
            position: new THREE.Vector3(-1.5, 0.25, 5),
      ...
      // 🕳️ 5. Narrow Escape
      {
        ...
        bumpers: [
          {
            position: new THREE.Vector3(-2.9, 0.25, 0),
            size: new THREE.Vector3(0.2, 0.5, 20),
        ...
        hazards: [
          {
            type: 'water',
            shape: 'rectangle',
            position: new THREE.Vector3(-2.75, 0, 0),
            size: { width: 1.5, length: 25 },
            depth: 0.2
          },
          {
            type: 'water',
        ...
        bumpers: [
          {
            ...
            size: new THREE.Vector3(2, 0.5, 0.2),
            rotation: new THREE.Euler(0, Math.PI / 4, 0)
          },
          {
            position: new THREE.Vector3(0, 0.25, -3),
        ...
        bumpers: [
          {
            ...
            size: new THREE.Vector3(0.2, 0.5, 8),
            rotation: new THREE.Euler(0, 0, 0)
          },
          {
