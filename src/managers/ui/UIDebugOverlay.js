...
export class UIDebugOverlay {
    ...
    init() {
        ...
        console.log('[UIDebugOverlay] Initialized.');
    }
    ...
    updateDebugDisplay(debugInfo) {
        ...
        if (!this.game.debugManager?.enabled) {
             if (this.debugElement.style.display !== 'none') {
                 ...
                 console.log('[UIDebugOverlay] Hiding debug overlay.');
             }
            return;
        }
        ...
        if (this.debugElement.style.display === 'none') {
            this.debugElement.style.display = 'block';
             console.log('[UIDebugOverlay] Showing debug overlay.');
        }
    ...
    cleanup() {
        ...
        this.debugElement = null;
        console.log('[UIDebugOverlay] Cleaned up.');
    }
} 